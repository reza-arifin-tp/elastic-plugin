 ...
 */
package com.tkpatlas.elasticsearch.plugin;

import com.tkpatlas.elasticsearch.service.FastLshSimilarityScriptEngineService;
 ...
 */
public final class FastLshSimilarityPlugin extends Plugin implements ScriptPlugin {

    public final ScriptEngineService getScriptEngineService(Settings settings) {
        return new FastLshSimilarityScriptEngineService(settings);
    }
