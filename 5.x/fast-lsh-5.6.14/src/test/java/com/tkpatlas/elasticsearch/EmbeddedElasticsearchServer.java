...
import com.tkpatlas.elasticsearch.plugin.FastLshSimilarityPlugin;
    ...
    private void startNodeInAvailablePort(Settings.Builder settings) throws NodeValidationException {
        ...
        while(!success) {
            try {
                ...
                node = new NodeExt(settings.build() , Arrays.asList(Netty3Plugin.class, PainlessPlugin.class, ReindexPlugin.class, FastLshSimilarityPlugin.class));
                node.start();
                success = true;
